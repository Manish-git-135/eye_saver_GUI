...
class App:
    def __init__(self, window, window_title, video_source=0):
        ...
        eyeBlinkCount_btn_image = tkinter.PhotoImage(file='./images/eyeCount.png')
        ...
        tkinter.Button(window, image=eyeBlinkCount_btn_image, border=0, borderwidth=0, highlightthickness=0,
                       fg='white', command=self.bc).place(x=110, y=210)
        ...
        # Button for stop
        tkinter.Button(window, text="Stop", border=0, borderwidth=0, highlightthickness=0, command=self.stop).place(x=0, y=0)
    ...
    def distance(self, frame):
        ...
        for rect in rects:
            ...
            self.dist_label['text'] = cv2.contourArea(np.reshape(shape, (68, 1, 2)))
